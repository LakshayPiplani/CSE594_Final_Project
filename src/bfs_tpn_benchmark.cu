...
template <int TPN>
__global__
void bfs_tpn_target(const int* h_edges, const uint32_t* d_offsets,
...
template <int TPN>
__global__
void bfs_tpn_bam(BamCache cache, const uint32_t* d_offsets,
                  int* d_distances, int num_nodes, int level,
...
template <int TPN>
__global__
void bfs_tpn_bam_2t(BamCache cache, const uint32_t* d_offsets,
                     int* d_distances, int num_nodes, int level,
                     int* d_frontier_size, const char* backing,
                     unsigned long long* d_edges_accessed) {
    const uint64_t tid     = blockDim.x * blockIdx.x + threadIdx.x;
...
BFSResult dispatch_bam_2t(int tpn, const int* h_edges, const uint32_t* d_offsets,
                           ...
                           size_t cache_bytes, uint32_t num_pages, int blk) {
    switch (tpn) {
        case 1:   return run_bam_tpn_2t<1>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 2:   return run_bam_tpn_2t<2>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 4:   return run_bam_tpn_2t<4>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 8:   return run_bam_tpn_2t<8>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 16:  return run_bam_tpn_2t<16>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 32:  return run_bam_tpn_2t<32>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 64:  return run_bam_tpn_2t<64>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 96:  return run_bam_tpn_2t<96>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 128: return run_bam_tpn_2t<128>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 160: return run_bam_tpn_2t<160>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 192: return run_bam_tpn_2t<192>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 224: return run_bam_tpn_2t<224>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 256: return run_bam_tpn_2t<256>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 288: return run_bam_tpn_2t<288>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 320: return run_bam_tpn_2t<320>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 512: return run_bam_tpn_2t<512>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        case 1024: return run_bam_tpn_2t<1024>(h_edges, d_offsets, num_nodes, num_edges, source, cache_bytes, num_pages, blk);
        default:
            fprintf(stderr, "Unsupported TPN=%d\n", tpn);
            exit(1);
    }
